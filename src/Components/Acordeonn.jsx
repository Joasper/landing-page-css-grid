...
export default function Acordeonn() {
  // let expanded = true;
    ...
    <div className="acordeonPc">
      ...
      >
        ...
        <AccordionDetails className="detalles" color="red">
          <Typography color={"white"} style={{ paddingTop: "20px" }}>
            ...
            <Button onClick={abrirr}>Siguiente</Button>
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion
      ...
      >
        ...
        <AccordionDetails className="detalles" color="red">
          ...
          <Button onClick={() => handleNext("panel1")}>Siguiente</Button>
        </AccordionDetails>
      </Accordion>
      <Accordion
